...
switch get(handles.axes.plotMode,'Value')
    case 1
        set(handles.yAxisORhistPanel,'SelectedChild',1);
        set(handles.rightColumn,'Sizes',[0 -1],'MinimumSizes',[0 200]);
    ...
    case 2
        set(handles.yAxisORhistPanel,'SelectedChild',2);
        set(handles.rightColumn,'Sizes',[60 -1],'MinimumSizes',[40 200]);
        set(handles.upPanel.panel,'Visible','on','SelectedChild',5);
...
switch hObject
    case  {handles.toolbar.polyGate,handles.menu.polyGate,...
        ...
        set(handles.rightColumn,'Sizes',[55 -1],'MinimumSizes',[55 200]);
        set(handles.upPanel.panel,'Visible','on','SelectedChild',1);
    ...
    case {handles.toolbar.autoGate,handles.menu.autoGate}
        set(handles.rightColumn,'Sizes',[55 -1],'MinimumSizes',[55 200]);
        set(handles.upPanel.panel,'Visible','on','SelectedChild',3);
    ...
    case {handles.toolbar.histGate,handles.menu.histGate}
        set(handles.rightColumn,'Sizes',[40 -1],'MinimumSizes',[40 200]);
        set(handles.upPanel.panel,'Visible','on','SelectedChild',6);
    ...
    case 'edit'
        switch(gates.type{editGate})
            case 'manual'
            	set(handles.rightColumn,'Sizes',[40 -1],'MinimumSizes',[40 200]);
                set(handles.upPanel.panel,'Visible','on','SelectedChild',2);
            ...
            case 'quadrant'
                ...
                set(handles.rightColumn,'Sizes',[40 -1],'MinimumSizes',[40 200]);
                set(handles.upPanel.panel,'Visible','on','SelectedChild',4);
...
if firstLoad||newWin
    set(handles.bigGrid,'Sizes',[-0.25 -1],'MinimumSizes',[210 200]);
